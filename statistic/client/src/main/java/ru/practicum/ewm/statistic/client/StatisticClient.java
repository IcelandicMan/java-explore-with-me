...
public class StatisticClient {
    ...
    @Autowired
    public StatisticClient(@Value("${statistic.server.address}") String serverUrl, RestTemplateBuilder builder) {
        rest = builder
    ...
    public ResponseEntity<Object> postHit(RequestHitDto requestHitDto) {
